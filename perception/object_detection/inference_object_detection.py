...
def run_inference():
    ...
    print(f"Running Inference for Object Detection Model: {model_path}")
    model = YOLO(model_path)
    
    # Run prediction
    results = model.predict(source=source_path, save=True, project=os.path.join(base_dir, 'test_results'), name='object_detection_inference')
